...
class BooksStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBooks = channel.unary_unary(
                '/Books/GetBooks',
                request_serializer=book__service__pb2.BookListRequest.SerializeToString,
                response_deserializer=book__service__pb2.BookListResponse.FromString,
                _registered_method=True)
...
def add_BooksServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBooks': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBooks,
                    request_deserializer=book__service__pb2.BookListRequest.FromString,
                    response_serializer=book__service__pb2.BookListResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Books', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Books', rpc_method_handlers)
...
class Books(object):
    ...
    def GetBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Books/GetBooks',
            book__service__pb2.BookListRequest.SerializeToString,
            book__service__pb2.BookListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
